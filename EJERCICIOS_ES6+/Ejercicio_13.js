...
console.log(removeItem(mainCharacters, 'Chewbacca')) // Elimina 'Chewbacca' y devuelve el nuevo array
console.log(removeItem(mainCharacters, 'Yoda')) // No se encuentra 'Yoda', devuelve el array sin cambios
console.log(removeItem(mainCharacters, 'Leia')) // Elimina 'Leia' y devuelve el nuevo array
